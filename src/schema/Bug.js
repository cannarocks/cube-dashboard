cube(`Bug`, {
    ...
    joins: {
        Tester: {
            relationship: `hasOne`,
            sql: `${Bug}.wp_user_id = ${Tester}.wp_user_id`
        },
        BugReplicability: {
            relationship: `hasOne`,
            sql: `${Bug}.bug_replicability_id = ${BugReplicability}.id`
        },
        BugSeverity: {
            relationship: `hasOne`,
            sql: `${Bug}.severity_id = ${BugSeverity}.id`
        },
        BugType: {
            relationship: `hasOne`,
            sql: `${Bug}.bug_type_id = ${BugType}.id`
        },
        BugStatus: {
            relationship: `hasOne`,
